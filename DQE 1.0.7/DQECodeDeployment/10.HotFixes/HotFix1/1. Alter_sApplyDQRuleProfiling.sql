USE [DataQualityDB]
GO
/****** Object:  StoredProcedure [DQ].[sApplyDQRuleProfiling]    Script Date: 04/07/2016 11:30:00 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER OFF
GO

ALTER PROC [DQ].[sApplyDQRuleProfiling] 
...
**     MG     06/07/2016    HotFix1: Resolve issue when handling column names with spaces 
*******************************************************************************/
